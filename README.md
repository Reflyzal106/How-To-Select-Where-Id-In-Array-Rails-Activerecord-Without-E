# [SOLVED] How-To-Select-Where-Id-In-Array-Rails-Activerecord-Without-E
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/how-to-select-where-id-in-array-rails-activerecord-without-e)
>
...
Use `find_or_initialize` or `first_or_create` to avoid exceptions when finding non-existent records.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/how-to-select-where-id-in-array-rails-activerecord-without-e)**
